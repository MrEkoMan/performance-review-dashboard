...
func newRouter() http.Handler {
	...
	r.Get("/api/ai-providers", getAIProviderConfigurations)
	r.Put("/api/ai-providers/{provider}", saveAIProviderConfiguration)
	r.Delete("/api/ai-providers/{provider}", deleteAIProviderConfiguration)
	...
	r.Get("/api/engineers/{engineerId}/onboarding-profile", getOnboardingProfile)
	r.Put("/api/engineers/{engineerId}/onboarding-profile", upsertOnboardingProfile)
	r.Post("/api/onboarding-profile/parse", parseOnboardingFile)
	...
	r.Get("/api/recognitions/{id}/attachments", getRecognitionAttachments)
